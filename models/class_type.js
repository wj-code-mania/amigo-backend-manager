...
exports.get_class_types = function (body, callback) {
    ...
    mongoClient.connect(settings.mongodb_host, { useNewUrlParser: true }, function(err, client) {
        ...
        mongodb.collection('class_type').aggregate([
            { 
                $match: {
                    "schoolId": schoolId,
                    "name" : {$regex:search}
...
exports.add_class_type = function (body, callback) {
    var schoolId = body.schoolId;
    var name = body.name;
...
exports.edit_class_type = function (body, callback) {
    var id = body.id;
    var schoolId = body.schoolId;
    var name = body.name;
    var status = body.status;
...
exports.del_class_type = function(id, callback) {
    mongoClient.connect(settings.mongodb_host, { useNewUrlParser: true }, function(err, client) {
        if (err) {
            return callback(err);
            client.close();
        ...
        assert.equal(null, err);
        var mongodb = client.db(settings.mongodb_dbname);
        mongodb.collection('class_type', {safe: true}, function (err, collection) {
            if (err) {
                return callback(err);
                client.close();
            }
