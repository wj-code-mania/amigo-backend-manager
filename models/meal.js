...
exports.get_meals = function (body, callback) {
    ...
    mongoClient.connect(settings.mongodb_host, { useNewUrlParser: true }, function(err, client) {
        ...
        mongodb.collection('meal').aggregate([
            { 
                $match: {
                    "schoolId": schoolId,
                    "name" : {$regex:search}
...
exports.add_meal = function (body, callback) {
    var schoolId = body.schoolId;
    var name = body.name;
    ...
    mongoClient.connect(settings.mongodb_host, { useNewUrlParser: true }, function(err, client) {
        ...
        assert.equal(null, err);
        var mongodb = client.db(settings.mongodb_dbname);
        mongodb.collection('meal', function (err, collection) {
            if (err) {
                return callback(err);
                client.close();
            }
...
exports.edit_meal = function (body, callback) {
    var id = body.id;
    var schoolId = body.schoolId;
    var name = body.name;
    var status = body.status;
...
exports.del_meal = function(id, callback) {
    mongoClient.connect(settings.mongodb_host, { useNewUrlParser: true }, function(err, client) {
        if (err) {
            return callback(err);
            client.close();
        ...
        assert.equal(null, err);
        var mongodb = client.db(settings.mongodb_dbname);
        mongodb.collection('meal', {safe: true}, function (err, collection) {
            if (err) {
                return callback(err);
                client.close();
            }
...
exports.get_meal_list = function (body, callback) {
    var schoolId = body.schoolId;
    mongoClient.connect(settings.mongodb_host, { useNewUrlParser: true }, function(err, client) {
        if (err) {
            return callback(err);
